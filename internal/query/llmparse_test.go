...
// TestLLMParser_MaxRetriesFromConfig_Zero verifies MaxRetries=0 means a
// single-attempt policy — an error-returning fake triggers the fallback to
// grammarSpec on the first error instead of the default 2 retries.
