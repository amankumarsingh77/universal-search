    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      {isSpotlightConflict && (
        <div style={styles.conflictCard}>
          <AlertTriangle size={18} color="var(--accent-warning)" style={{ flexShrink: 0 }} />
          <div>
            <div style={{ fontWeight: 600, color: 'var(--accent-warning)', fontSize: 14 }}>Possible conflict with Spotlight</div>
            <div style={{ fontSize: 13, color: 'var(--accent-warning)', marginTop: 4 }}>
